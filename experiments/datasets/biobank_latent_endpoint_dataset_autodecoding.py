...
class LatentEndpointDatasetAutodecoding(Dataset):
    def __init__(self, healthy_hdf5_path, endpoint_name, endpoints_dir="/projects/prjs1252/data_jesse_final_v3/endpoints/",
        ...
        base_dir = "/projects/prjs1252/data_jesse_final_v3/autodecoding_latent_datasets"
        total_latents = latents_per_dim ** 4
        self.endpoint_hdf5_path = os.path.join(
            base_dir, 
            f"{total_latents}latents_32dim_{endpoint_name}_endpoint_500epochs_pretrain_1000patients_3200_epochs.h5"
        )
...
def create_dataloaders(healthy_hdf5_path, endpoint_name, batch_size=16, 
    ...
    dataset = LatentEndpointDatasetAutodecoding(
