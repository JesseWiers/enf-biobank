...
def get_config():
    ...
    config.dataset.num_patients_train = 10 # 10 = 4950 samples, 5 = 2400 samples, 4 = 1800, 3 = 1350 
...
def main(_):
    ...
    num_subsamples = int((img_shape[0] * img_shape[1]) / 100) # 2048

    # Init the model
    recon_enf_params = recon_enf.init(key, x[:,:num_subsamples,:], *temp_z)
